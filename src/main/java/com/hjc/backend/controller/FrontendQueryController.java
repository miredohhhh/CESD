...
public class FrontendQueryController {
    ...
    public ApiResponse<MyApplicationStatisticsVO> getMyApplicationStatistics(@RequestParam Long studentId) {
        return ApiResponse.success(materialApplicationService.getMyApplicationStatistics(studentId));
    }
    ...
    @GetMapping("/my-score")
    public ApiResponse<FrontendScoreSummaryVO> getMyScore(@RequestParam Long studentId) {
        return ApiResponse.success(scoreSummaryService.getMyScore(studentId));
    }

    @Operation(summary = "Get my category scores")
    @GetMapping("/my-score/categories")
    public ApiResponse<List<ScoreCategorySummaryVO>> getMyCategoryScores(@RequestParam Long studentId) {
        return ApiResponse.success(scoreSummaryService.getMyCategoryScores(studentId));
    }
