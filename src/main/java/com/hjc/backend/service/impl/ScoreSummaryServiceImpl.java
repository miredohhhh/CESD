...
public class ScoreSummaryServiceImpl extends ServiceImpl<ScoreSummaryMapper, ScoreSummary> implements ScoreSummaryService {
    ...
    @Override
    public FrontendScoreSummaryVO getMyScore(Long studentId) {
    ...
    @Override
    public List<ScoreCategorySummaryVO> getMyCategoryScores(Long studentId) {
        // TODO After authentication is introduced, studentId must come from current user context instead of request parameters.
        return listStudentCategoryScores(studentId);
    }
